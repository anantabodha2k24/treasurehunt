  ...
  return (
    <>
        <div className="flex  justify-center items-center h-screen">
          <div className="flex flex-col w-4/6 h-2/3 justify-center flex-wrap bg-rose-500 rounded border-2 border-white">
            <h1 className="text-center text-xl text-white h-1/6 pt-2">
            Social Media
            </h1>
